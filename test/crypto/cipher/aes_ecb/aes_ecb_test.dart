...
import 'encrypt_test.dart';
import 'decrypt_test.dart';

final List<GrillGroupFunc> testGroupList = [encryptTest, decryptTest];
final List<GrillGroupFunc> benchmarkGroupList = [encryptBenchmark, decryptBenchmark];
